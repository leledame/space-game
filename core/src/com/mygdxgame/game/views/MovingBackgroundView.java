...
public class MovingBackgroundView extends View {
    ...
    public void move() {
        ...
        if (texture1Y <= -GameSettings.SCREEN_HEIGHT) texture1Y = GameSettings.SCREEN_HEIGHT;
        if (texture2Y <= -GameSettings.SCREEN_HEIGHT) texture2Y = GameSettings.SCREEN_HEIGHT;
    }
